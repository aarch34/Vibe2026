...
export function ZonalStaffLoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!username.trim() || !password.trim()) {
      setErrorMsg("Please enter both username/email and station passcode");
      return;
    }
    ...
    try {
      ...
      if (res.success && res.redirectUrl) {
        ...
        setErrorMsg(res.message || "Invalid credentials or passcode");
      }
    } catch (err: any) {
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. user@gmail.com, taranaga1, taranaga"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. taranaga@vibe2026 or station pass"
                  className="w-full pl-10 pr-4 py-2.5 bg-muted border-2 border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary font-mono font-bold"
                />
              </div>
            </div>
