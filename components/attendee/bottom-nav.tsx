...
export function AttendeeBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 max-w-md mx-auto px-2 pb-safe pt-2 bg-card border-t-2 border-border shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
