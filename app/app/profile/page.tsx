...
export default async function ProfilePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="p-4 rounded-2xl bg-gradient-to-br from-slate-900 via-blue-950/40 to-slate-900 border border-slate-800 shadow-xl space-y-3">
        <div className="flex items-center space-x-3">
          <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-500 p-0.5 shadow-md">
      ...
      <div id="passport" className="space-y-2.5">
        <div className="flex items-center justify-between">
          ...
          {passportZones.map((item) => (
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 block mt-0.5">
                {item.isUnlocked
                  ? `${item.completedExperiencesCount} Missions Completed`
                  : "Unvisited"}
              </span>
            </div>
          ))}
